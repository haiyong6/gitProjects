 ...
 */
@Controller
public class SubmodelProfitGlobalController extends BaseController{
	
	protected final Log log = LogFactory.getLog(SubmodelProfitGlobalController.class);
	@Autowired
	private SubmodelProfitGlobalManager submodelProfitGlobalManager;
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getCityModal")
    ...
    {	
    	...
    	submodelProfitGlobalManager.getCityModal(request,paraMap);
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getSubmodelModal")
    public ModelAndView getSubmodelModal(HttpServletRequest request,HttpServletResponse response) throws Exception
    {
    	...
    	submodelProfitGlobalManager.getSubmodelModal(request,map);
    	//返回细分市场页
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getManfModal")
    public ModelAndView getManfModal(HttpServletRequest request,HttpServletResponse response) throws Exception
    {
    	Map<String, Object> map = getPageParams(request);
    	submodelProfitGlobalManager.getManfModal(request,map);
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getVersionModalByCommon")
    public ModelAndView getVersionModalByCommon(HttpServletRequest request) throws Exception 
    {
    	Model model = new ExtendedModelMap();
    	submodelProfitGlobalManager.getVersionModalByCommon(request,getPageParams(request));
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getSegmentAndChildren")
    public ModelAndView getSegmentAndChildren(HttpServletRequest request) throws Exception 
    {
    	Model model = new ExtendedModelMap();
    	submodelProfitGlobalManager.getSegmentAndChildren(request,getGlobalParams(request));
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getManf")
    public ModelAndView getManf(HttpServletRequest request) throws Exception 
    {
    	Model model = new ExtendedModelMap();
    	submodelProfitGlobalManager.getManf(request,getGlobalParams(request));
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getBrand")
    public ModelAndView getBrand(HttpServletRequest request) throws Exception 
    {
    	Model model = new ExtendedModelMap();
    	submodelProfitGlobalManager.getBrand(request,getGlobalParams(request));
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getBodyType")
    public ModelAndView getBodyType(HttpServletRequest request) throws Exception 
    {
    	Model model = new ExtendedModelMap();
    	submodelProfitGlobalManager.getBodyType(request,getGlobalParams(request));
     ...
     * @throws Exception
     */
    @RequestMapping("/policy/submodelProfitGlobal/getAutoCustomGroup")
    public ModelAndView getAutoCustomGroup(HttpServletRequest request,HttpServletResponse response) throws Exception
    {	
    	Map<String, Object> paraMap = getPageParams(request);
    	submodelProfitGlobalManager.getAutoCustomGroup(request,paraMap);
     ...
     * @param response
     */
    @RequestMapping({"/policy/checkPopBoxTpData"})
    public void checkPopBoxTpData(HttpServletRequest request, HttpServletResponse response)
    {
	      ...
	      String json = submodelProfitGlobalManager.checkPopBoxTpData(request, paramsMap);
	      try {
	        print(response, json);
	      } catch (IOException e) {
	        e.printStackTrace();
