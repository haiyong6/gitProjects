	...
	<div class="modal-header">
		<button type="button" class="close reset" data-dismiss="modal" aria-hidden="true">×</button>
  		...
  		<div id="segmentType">
  		   ...
  		   <input type="checkbox" name="segmentType" class="segmentType" segmentValue="1" checked="true" value="Volume"><span style="font-weight:normal;font-size:14px;">Volume</span>&nbsp;
  		   <input type="checkbox" name="segmentType" class="segmentType" segmentValue="2" checked="true" value="Economy"><span style="font-weight:normal;font-size:14px;">Economy</span>&nbsp;
  		   <input type="checkbox" name="segmentType" class="segmentType" segmentValue="3" checked="true" value="Premium"><span style="font-weight:normal;font-size:14px;">Premium</span>&nbsp;
  		   <input type="checkbox" name="segmentType" class="segmentType" segmentValue="4" checked="true" value="Budget"><span style="font-weight:normal;font-size:14px;">Budget</span>&nbsp;
  		   <input type="checkbox" name="segmentType" class="segmentType" segmentValue="5" checked="true" value="Luxury"><span style="font-weight:normal;font-size:14px;">Luxury</span>&nbsp;
