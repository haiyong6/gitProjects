    ...
    jQuery.fn.waysDatepicker = function(options) {	
        ...
        return $(this).each(function() {
            ...
            n.bind("click",function() {
                ...
                var offsetLeft    = n.offset().left;
                var $calendarContainer = $calendar.closest('.calendar-container')
                var calendarWidth = $calendar.outerWidth();
                var elmWidth = $calendarContainer.length > 0 ? $calendarContainer.width() : n.width()
                if( (offsetLeft + calendarWidth) > $(window).width()){
                    $calendar.css({
                        left: - (calendarWidth - elmWidth)
                    })
                }else{
                    $calendar.css({
                        left: 0
