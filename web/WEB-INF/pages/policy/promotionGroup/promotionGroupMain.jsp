...
<div class="breadLine">
    <ul class="breadcrumb">
        <li>终端支持分析<span class="divider">></span></li>                
        <li class="active">促销分类分析</li>
    </ul>
</div>
<div class="workplace">
            	...
            	<div class="row-fluid">
            		<table style="width: 100%">
            			<tr>
										...
										<div class="control-group">
						    				...
						    				<div class="controls">
										    	<select id="objectType" name ="objectType" >
										      		...
										      		<option value="2" selected="selected">车型</option>
            				...
            				<td>
            					 <img alt="" src="${ctx }/img/outGive/promotionGroup.png"> 
            				</td>
            			</tr>
            		</table>
                </div>
	...
	<div class="row-fluid">
		<div class="span12">                    
        	<div class="head clearfix">
        		<form action="${ctx }/promotionGroup/exportExcel" method="post" id="exportFormId">
...
<script type="text/javascript" src="${ctx}/js/app/policy/promotionGroup/promotionGroup.js"></script>  
