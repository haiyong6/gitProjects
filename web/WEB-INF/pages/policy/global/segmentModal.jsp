	...
	<c:forEach items="${segmentList}" var="segment">
		<tr class="selectorTR">
	    	<td class="selectorTypeTd">
	     		<label>
					<input type="checkbox" value="${segment.segmentId}" class="segmentModalByLevel1"/>${segment.segmentName}
				</label>
			</td>
	     		...
	     		<div class="form-inline" >
	     			<c:forEach items="${segment.segmentList}" var="subSegment">
		       			<label class="checkbox" style="width:100px">
							<input type="checkbox" value="${subSegment.segmentId}" name="segmentIdInput" class="segmentModalByLevel2" />
...
$(document).ready(function(){
 	$("#segmentModalResultContainer",window.parent.document).find("div").each(function(){
