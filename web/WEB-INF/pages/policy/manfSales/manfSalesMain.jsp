...
<div class="workplace">
            	...
            	<div class="row-fluid">
            		<table style="width: 100%">
            			<tr>
			                    		...
			                    		<div class="control-group">
						    				...
						    				<div class="controls">
										    	<select id="frequencyType"  >
										      		...
										      		<option value="2" selected="selected">季</option>
						  				...
						  				<div class="control-group">
						    				...
						    				<div class="controls">
						    					<div class="form-inline">
													 ...
													 <span class="2">  </span>						
							      					<span id="season-container" class="input-append date">
													...
													<select id="seasonType" style="display:none" ; >
										...
										<div class="control-group">
						    				...
						    				<div class="controls">
										    	<select id="objectType" name ="objectType" >
										    		...
										    		<option value="2" selected="selected">厂商品牌</option>
            				...
            				<td style="width:45%">
            					 <img alt="" src="${ctx }/img/outGive/manfSales.png"> 
            				</td>
            			</tr>
            		</table>
                </div>
    ...
    <div class="row-fluid">
		<div class="span12">                    
        	<div class="head clearfix">
        		<form action="${ctx }/manfSales/exportExcel" method="post" id="exportFormId">
	                 ...
	                 <input type="hidden" name="ex_beginDate" id="ex_beginDate" /><!-- 开始时间 -->
                 	 ...
                 	 <input type="hidden" name="ex_seasonType" id="ex_seasonType" /><!-- 季度频次 -->
                 	 <input type="hidden" value="${endDate}" name="ex_maxDate" id="ex_maxDate" /><!-- 最新月份 -->
                 </form> 
             </div>
	             	...
	             	<div class="tab-pane active" id="tabs-1">
	                 	<div class="row-fluid">
	                     	<div class="span12" style="background-color:#FFF;" id="chartTitleDiv">
	                        		...
	                        		<div class="block-fluid table-sorting clearfix" id="chartId" style="height:500px;padding-top: 15px;"></div>
	                        		<div id="chartTable"  style="height:110px ;margin-left:120px;"></div>
	                        </div>
	                     </div>
	                 </div>
...
<%@ include file="/common/template/manfSalesTemplate/segmentModalTemplate.jsp"%>
<script type="text/javascript" src="${ctx}/js/plugins/echarts/echarts-all.js"></script>
<script type="text/javascript" src="${ctx}/js/app/policy/manfSales/manfSales.js"></script>
