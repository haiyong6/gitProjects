...
<ul style="margin:10px;padding:0px;">
	<c:forEach items="${bodyTypeList}" var="bodyType">
		<li style="list-style: none;width: 24%;float: left;padding-left: 5px;">
	     	<label class="checkbox" style="font-size: 12px;color: #3675b4;">
				<input type="${inputType == 1?'checkbox':'radio'}" value="${bodyType.bodyTypeId}" name="bodyTypeIdInput" class="bodyTypeModal" />
