...
<div>
	...
	<div class="tab-content">
		...
		<!-- 细分市场——开始 -->
		<div class="tab-pane" id="tabs-segment" style="height:300px;overflow: auto;"></div>
		<!-- 细分市场——结束 -->


		<!-- 品牌——开始 -->
		<div class="tab-pane" id="tabs-brand" style="height:300px;overflow: auto;"></div>
		<!-- 品牌——结束 -->


		<!-- 厂商——开始 -->
		<div class="tab-pane" id="tabs-manf" style="height:300px;overflow: auto;"></div>
		<!-- 厂商——结束 -->
	</div>
</div>