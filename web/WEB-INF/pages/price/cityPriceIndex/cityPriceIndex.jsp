...
<div class="workplace">
                	...
                	<div class="span12">
  					...
  					<div class="control-group">
							    ...
							    <div class="controls">
								    ...
								    <div class="span10" style="margin-left:0px;width:28%;" id="cityModalResultContainer">
								    ...
								    <div style="/* margin-left:10px; */margin-top: 2px;">
				  						拆分
				  						<input name = "city_Split" id ="citySplit" type="checkbox" value="checkbox">
									</div>
							    </div>
							</div>
	...
	<div class="row-fluid">
		<div class="span12">                    
        	<div class="head clearfix">
        		<form action="${ctx }/exportCityPriceIndexOriginalData" method="post" id="exportFormId">
...
<script type="text/javascript" src="${ctx}/js/app/price/cityPriceIndex/cityPriceIndex.js"></script>  
</body>
</html>