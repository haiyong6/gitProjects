...
<div class="workplace">
            	...
            	<div class="row-fluid">
                	<div class="span12">
                    	<form class="form-horizontal" id="formId">
			  				...
			  				<div class="control-group">
			  					<label class="control-label" for="analysisDimension">数据范围：</label>
			  					<div class="controls">
			    				<select id="msrpType">
			    					<option value="0">历史指导价</option>
			    					<option value="1" selected>最新指导价</option>
			    				</select>
			    				</div>
			  				</div>
	...
	<div class="row-fluid">
		<div class="span12">                    
        	<div class="head clearfix">
        		<form action="${ctx}/price/msrpQuery/exportExcelMap" method="post" id="exportFormId">
...
<script type="text/javascript" src="${ctx}/js/app/price/msrpQuery/msrpQuery.js"></script>  
</body>
</html>